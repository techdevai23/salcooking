          ...
          <div class="premium-section">
              ...
              <?php if ($usuario['es_premium']): ?>
                <div class="premium-status">
                  ...
                  <img src="sources/iconos/Vip-Circle--Streamline-Ultimate.png" width="34px" alt="Premium">
            ...
            <?php else: ?>
              <div style="display: flex; justify-content: center; align-items: center; width: 100%; padding: 32px 0; color: var(--naranja-corp); font-size:1.1rem; text-align:center;">
                <div style="max-width: 400px;">
                  <strong>Haz clic en el botón "Hazte Prémium" para conseguir tu código de registro.</strong><br>
                  Podrás accceder a los filtros para indicar tus alergias, intolerancias, enfermedades y generar dietas semanales.
                </div>
              </div>
            <?php endif; ?>
          </div>
