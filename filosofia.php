    ...
    <div class="contenido-filosofia">
      ...
      <div class="foto">
        ...
        <div class="gif-container">
            ...
            <img src="sources/videos/montaje_diferentes_logos-comprimido.gif" alt="Montaje de diferentes logos" width="100%">
          ...
          <div id="audioModal" class="filosofia-modal" style="display:none;">
            <div class="filosofia-modal-dialog">
              <div class="filosofia-modal-content">
                <a href="filosofia.php"><img src="sources/iconos/Arrow-Thick-Left-3--Streamline-Ultimate.svg" width="25px" alt="volver"></a>
        ...
        Tu navegador no soporta el elemento de audio.
                ...
                <audio controls>
                  <source id="audioRNE" src="https://raw.githubusercontent.com/techdevai23/salcooking/main/sources/audios/entrevista-completa-SalCooking-Premium.wav" type="audio/wav">
                  Tu navegador no soporta el elemento de audio.
                </audio>
          ...
          <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
              ...
              function cerrarModal() {
                ...
                // Pausar y reiniciar el audio
                const audio = document.getElementById("audioRNE");
                if (audio) {
                  audio.pause();
              ...
              // Cerrar modal al hacer clic fuera (en el fondo del modal)
